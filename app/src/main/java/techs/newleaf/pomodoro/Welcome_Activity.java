    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == RC_SIGN_IN){
            ...
            if(result.isSuccess()){
                ...
                Toast.makeText(getApplication(),"Google Login Successfull",Toast.LENGTH_SHORT).show();
                temp=0;
            }
            else
                Toast.makeText(getApplication(),"Google Login Failed",Toast.LENGTH_SHORT).show();
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText("  Sign Up With Google");
                btnNext.setCompoundDrawablesWithIntrinsicBounds(R.drawable.google, 0, 0, 0);
