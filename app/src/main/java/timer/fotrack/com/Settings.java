...
public class Settings extends AppCompatActivity {
    private LinearLayout notification,Invite,Share;
   ...
   static public String chosenRingtone;
    static public int vibrationState;
    static public int ScreenState=0;
    static public String ColurBg;
    private LinearLayout Rate,Feedback,website,ProdectTour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Invite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                appLinkUrl = "https://fb.me/1034998716612798";
        ...
        Share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Fotrack");
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "\"Focusing has never been so easy.\" \n" +
                        "Fotrack will help you finish your task on time by using the Pomodoro technique®.  https://play.google.com/store/apps/details?id=timer.fotrack.com");
        ...
        Rate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Try Google play
                intent.setData(Uri.parse("market://details?id=timer.fotrack.com"));
                if (!MyStartActivity(intent)) {
                    //Market (Google play) app seems not installed, let's try to open a webbrowser
                    intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=timer.fotrack.com"));
                    if (!MyStartActivity(intent)) {
        ...
        website.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri uri = Uri.parse("http://fotrack.com/"); // missing 'http://' will cause crashed
        ...
        ProdectTour=(LinearLayout)findViewById(R.id.Tour);
        ProdectTour.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Settings.this,ProductTour.class);
                startActivity(intent);
            }
        });
       ...
       PomoText.setText(min+" Minutes");
        ...
        pomoTimer.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                final Snackbar snackBar = Snackbar.make(findViewById(android.R.id.content), "Change of time will effect from next Pomodoro", Snackbar.LENGTH_LONG);
        ...
        ShortTimer.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                final Snackbar snackBar = Snackbar.make(findViewById(android.R.id.content), "Change of time will effect from next Short time", Snackbar.LENGTH_LONG);
                snackBar.setActionTextColor(Color.parseColor("#80cbc4"));
                snackBar.setAction("Dismiss", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
       ...
       LongTimer.setProgress(LongProgress);
        LongTimer.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                final Snackbar snackBar = Snackbar.make(findViewById(android.R.id.content), "Change of time will effect from next Long time", Snackbar.LENGTH_LONG);
                snackBar.setActionTextColor(Color.parseColor("#80cbc4"));
                snackBar.setAction("Dismiss", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
